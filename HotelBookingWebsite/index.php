...
<!-- Swiper Carousal-->
 		...
 		<div class="col-lg-12 bg-white shadow p-4 rounded">
 			...
 			<form>
 				<div class="row align-items-end">
 					...
 					<div class="col-lg-3 mb-3">
 						<label class="form-label" style="font-weight: 500;">ผู้ใหญ่</label>
 					...
 					<div class="col-lg-2 mb-3">
 						<label class="form-label" style="font-weight: 500;">เด็ก</label>
 						<select class="form-select shadow-none">
 					...
 					<div class="col-lg-1 mb-lg-3 mt-2">
 						<button type="submit" class="btn text-white shadow-none custom-bg">ส่ง</button>
 					</div>
 ...
 <!-- Our Rooms -->
 <h2 class="mt-5 pt-4 mb-4 text-center fw-bold h-font">บรรยากาศของเรา</h2>
 <div class="container">
 	<div class="row">
