<nav class="navbar navbar-expand-lg bg-light px-lg-3 py-lg-2 shadow-sm sticky-top">
  <div class="container-fluid">
    <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php">D' Bu Di Beach Resort </a>
    ...
    <div class="modal-content">
    	...
    	<form>
        	...
        	<button type="reset" class="btn-close shadow-none" data-bs-dismiss="modal" aria-label="Close"></button>
      		...
      		<div class="modal-body">
      			<span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">หมายเหตุ: รายละเอียดของคุณต้องตรงกับบัตรประจำตัวของคุณ (บัตร Aadhaar หนังสือเดินทาง ใบขับขี่ ฯลฯ) ที่จำเป็นในการเช็คอิน
    			</span>
    		<div class="container-fluid">
    			<div class="row">
