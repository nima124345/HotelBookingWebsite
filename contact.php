  ...
  <div class="row">
    <div class="col-lg-6 col-md-6 mb-5 px-4">
      <div class="bg-white rounded shadow p-4">
        ...
        <a href="tel: +94768799665" class="d-inline-block mb-2 text-decoration-none text-dark"><i class="bi bi-telephone-fill"></i> 0872864243</a>
        <br>
        <a href="tel: +94768799665" class="d-inline-block mb-2 text-decoration-none text-dark"><i class="bi bi-telephone-fill"></i> 0812774379 </a>
    ...
    <div class="col-lg-6 col-md-6 mb-5 px-4">
      <div class="bg-white rounded shadow p-4">
        <form>
          ...
          <div class="mb-3">
          <label class="form-label" style="font-weight: 500;">อีเมล์</label>
          ...
          <button type="submit" class="btn text-white custom-bg mt-3">ส่ง</button>
        </form>
      </div>
    </div>
</div>
